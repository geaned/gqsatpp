...
# Usage: ./train.sh -t TRAIN_PROBLEMS_PATHS -v VAL_PROBLEMS_PATHS [-u BATCH_UPDATES]

train=../../benchmark/satlib/random3sat/uf50-218-fixed/train
val=../../benchmark/satlib/random3sat/uf50-218-fixed/val
batch_updates=50000

while getopts t:v:b: flag
do
  case "${flag}" in
    t) train=${OPTARG};;
    v) val=${OPTARG};;
    b) batch_updates=${OPTARG};;
  esac
done
