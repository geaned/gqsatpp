...
def main():
    ...
    for with_restarts in [False, True]:
        ...
        env = gym.make("sat-v0", args=args, problems_paths=args.eval_problems_paths,
                       test_mode=True, with_restarts=with_restarts)
        # print(env)
        agent = MiniSATAgent()
        ...
        while env.test_to != 0 or pr == 0:
            ...
            print(f'Rollout {pr + 1}, steps {env.step_ctr}, num_restarts {info["num_restarts"]}.')
